...
<form class = "modal-content" action="" method="POST">
  <div class="container">
    ...
    <label for="event"><b>Cultural Event</b></label>
    ...
    <input type="text" placeholder="Enter Timings" name="time" required>



   <center><input type="submit" name="submit" value="Add" class="registerbtn"></center>
  </div>
...
$query = "INSERT INTO cultural VALUES('$e','$v','$d','$t')";
