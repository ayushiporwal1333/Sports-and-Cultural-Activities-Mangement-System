	 ...
	 if($total != 0)
	 {
		...
		while($result = mysqli_fetch_assoc($data))
		{
				echo "<tr>
					...
					<td>".$result['Date']."</td>
					<td>".$result['Time']."</td>
					<td><a href='cupdate.php?e=$result[Event]&v=$result[Venue]&d=$result[Date]&t=$result[Time]'>EDIT</a></td>
					<td><a href='cdelete.php?e=$result[Event]' onclick='return check()'>DELETE</a></td>
					</tr>";
		}
	 }
?>
