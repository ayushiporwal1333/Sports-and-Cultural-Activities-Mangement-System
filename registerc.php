...
<form class = "modal-content" action="" method="POST">
  <div class="container">
    ...
    <label for="auid"><b>AUID</b></label>
    <input type="text" placeholder="Enter AUID" name="auid" required>
	...
	<label for="no."><b>Mobile No.</b></label>
    <input type="text" placeholder="Enter Mobile No." name="mobile" required>



    <center><input type="submit" name="submit" value="Register" class="registerbtn"></center>
  </div>
...
$query = "INSERT INTO registration VALUES('$nm','$id','$dp','$ev','$em','$no')";
